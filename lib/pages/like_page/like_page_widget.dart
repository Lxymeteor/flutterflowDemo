  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final likePageGetUsersResponse = snapshot.data!;
                  ...
                  Expanded(
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        child: Builder(
                          builder: (context) {
                            final partner = AllUsersStruct.maybeFromMap(
                                        likePageGetUsersResponse.jsonBody)
                                    ?.data
                                    .toList() ??
                                [];
