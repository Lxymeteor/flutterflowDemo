...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/minePage',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'minePage')
              : const NavBarPage(
                  initialPage: 'minePage',
                  page: MinePageWidget(),
                ),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          path: '/creativePage',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'CreativePage')
              : const CreativePageWidget(),
        ),
        FFRoute(
          name: 'likePage',
          path: '/likePage',
        ...
        FFRoute(
          name: 'nearbyPage',
          path: '/nearbyPage',
          builder: (context, params) => const NearbyPageWidget(),
        )
